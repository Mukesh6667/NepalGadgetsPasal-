"use strict";
// ================================================================
// NepalGadgetsPasal — Complete Script v3
// Firebase CDN (no bundler needed), works perfectly on GitHub Pages
// ================================================================

// Firebase loaded via CDN in index.html — use window.firebase globals
// We use compat version for simplicity
...
// ================================================================
// DEFAULT PRODUCTS (fallback + seed data)
// ================================================================
const DEFAULT_PRODUCTS = [
  ...
  { id:2,  name:"Samsung Galaxy S24",     brand:"Samsung",  cat:"smartphones",  price:109900, old:129900, disc:15, rating:4.7, rev:643,  icon:"fa-mobile-alt",     img:"https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=320&h=320&fit=crop&auto=format&q=75", desc:"Galaxy AI, 50MP camera with 30x Zoom, Snapdragon 8 Gen 3.", specs:[["Display","6.2\" Dynamic AMOLED 2X"],["Chip","Snapdragon 8 Gen 3"],["Camera","50MP+10MP+12MP"],["Battery","4000mAh"],["Storage","128/256GB"],["OS","Android 14"]] },
  { id:3,  name:"MacBook Air M3",         brand:"Apple",    cat:"laptops",      price:169900, old:189900, disc:11, rating:4.9, rev:412,  icon:"fa-laptop",         img:"https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=320&h=320&fit=crop&auto=format&q=75", desc:"M3 chip, 18hr battery, 11.5mm thin, 1.24kg. The world's best laptop.", specs:[["Chip","Apple M3"],["Display","13.6\" Liquid Retina"],["RAM","8GB/16GB/24GB"],["Storage","256GB–2TB"],["Battery","18hr"],["Weight","1.24kg"]] },
  { id:4,  name:"Dell XPS 15",            brand:"Dell",     cat:"laptops",      price:229900, old:259900, disc:12, rating:4.6, rev:287,  icon:"fa-laptop",         img:"https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=320&h=320&fit=crop&auto=format&q=75", desc:"OLED display, Intel Core i7, NVIDIA RTX 4060. Ultimate Windows laptop.", specs:[["Processor","Intel Core i7-13700H"],["Display","15.6\" OLED 3.5K"],["RAM","16GB DDR5"],["Storage","512GB NVMe SSD"],["GPU","NVIDIA RTX 4060"],["Battery","86Whr"]] },
  { id:5,  name:"Sony WH-1000XM5",        brand:"Sony",     cat:"earbuds",      price:44900,  old:54900,  disc:18, rating:4.8, rev:1204, icon:"fa-headphones-alt", img:"https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=320&h=320&fit=crop&auto=format&q=75", desc:"Industry-leading ANC, 30hr battery, V1 chip for crystal clear calls.", specs:[["Driver","30mm Dome"],["ANC","Industry Best"],["Battery","30hr (ANC on)"],["Charging","USB-C Quick Charge"],["Bluetooth","5.2"],["Weight","250g"]] },
  { id:6,  name:"Apple Watch Series 9",   brand:"Apple",    cat:"smartwatches", price:59900,  old:69900,  disc:14, rating:4.8, rev:723,  icon:"fa-clock",          img:"https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=320&h=320&fit=crop&auto=format&q=75", desc:"S9 chip, brighter always-on display, double tap, ECG, blood oxygen.", specs:[["Chip","Apple S9 SiP"],["Display","Always-On LTPO OLED"],["Battery","Up to 18hr"],["Water","50m"],["Health","ECG, Blood O2"],["Bluetooth","5.3"]] },
  { id:7,  name:"JBL Charge 5",           brand:"JBL",      cat:"speakers",     price:19900,  old:24900,  disc:20, rating:4.7, rev:956,  icon:"fa-volume-up",      img:"https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=320&h=320&fit=crop&auto=format&q=75", desc:"40W Pro Sound, IP67 waterproof, 20hr playtime, built-in powerbank.", specs:[["Output","40W"],["Battery","20hr"],["Waterproof","IP67"],["Bluetooth","5.1"],["PartyBoost","Yes"],["Weight","960g"]] },
  { id:8,  name:"Logitech G502 X",        brand:"Logitech", cat:"gaming",       price:12900,  old:15900,  disc:19, rating:4.6, rev:574,  icon:"fa-gamepad",        img:"https://images.unsplash.com/photo-1527814050087-3793815479db?w=320&h=320&fit=crop&auto=format&q=75", desc:"HERO 25K sensor, LIGHTFORCE hybrid switches, 13 programmable buttons.", specs:[["Sensor","HERO 25K"],["DPI","100–25,600"],["Switches","LIGHTFORCE"],["Buttons","13 Prog."],["Weight","89g"],["Interface","USB"]] },
  { id:9,  name:"OnePlus 12",             brand:"OnePlus",  cat:"smartphones",  price:89900,  old:99900,  disc:10, rating:4.6, rev:398,  icon:"fa-mobile-alt",     img:"https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=320&h=320&fit=crop&auto=format&q=75", desc:"Snapdragon 8 Gen 3, Hasselblad cameras, 100W SUPERVOOC, 5400mAh.", specs:[["Display","6.82\" ProXDR AMOLED"],["Chip","Snapdragon 8 Gen 3"],["Camera","50MP Hasselblad"],["Battery","5400mAh/100W"],["Storage","256/512GB"],["OS","OxygenOS 14"]] },
  { id:10, name:"GoPro Hero 12",          brand:"GoPro",    cat:"cameras",      price:54900,  old:64900,  disc:15, rating:4.7, rev:329,  icon:"fa-camera",         img:"https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=320&h=320&fit=crop&auto=format&q=75", desc:"5.3K60 video, 27MP photos, HyperSmooth 6.0, waterproof to 10m.", specs:[["Video","5.3K60/4K120"],["Photo","27MP"],["Stabilization","HyperSmooth 6.0"],["Waterproof","10m"],["Battery","1720mAh"],["Weight","154g"]] },
  { id:11, name:"Samsung Galaxy Watch 6", brand:"Samsung",  cat:"smartwatches", price:39900,  old:49900,  disc:20, rating:4.5, rev:412,  icon:"fa-clock",          img:"https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=320&h=320&fit=crop&auto=format&q=75", desc:"Advanced sleep analysis, BIA body composition, sapphire glass, 40hr.", specs:[["Display","1.3\" Super AMOLED"],["Processor","Exynos W930"],["Battery","40hr"],["Water","5ATM+IP68"],["Health","BIA, ECG, SpO2"],["OS","Wear OS 4"]] },
  { id:12, name:"JBL Tune Buds",          brand:"JBL",      cat:"earbuds",      price:8900,   old:11900,  disc:25, rating:4.4, rev:863,  icon:"fa-headphones-alt", img:"https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=320&h=320&fit=crop&auto=format&q=75", desc:"48hr total battery, Active Noise Cancelling, 4 mics, JBL Pure Bass.", specs:[["Battery (Bud)","10hr ANC"],["Battery (Total)","48hr"],["ANC","Yes"],["Driver","10mm"],["Bluetooth","5.3"],["Water","IPX4"]] }
];
...
function toast(msg, icon="fa-check-circle", color="#10b981") {
  ...
  document.getElementById("toast-icon").className  = "fa " + icon;
...
function initNavbar() {
  ...
  document.addEventListener("click", e => {
    if (!nav?.contains(e.target)) { hbg?.classList.remove("open"); nls?.classList.remove("open"); }
  });
}

// ================================================================
// FIREBASE — LOAD & SYNC PRODUCTS
// ================================================================
function loadProducts() {
  // Always show defaults immediately — no blank screen
  renderProducts();

  db.collection("products").onSnapshot(snap => {
    if (snap.size >= 10) {
      // Firebase has all products — use them
      PRODUCTS = snap.docs.map(d => ({ fbId: d.id, ...d.data() }));
    } else {
      // Firebase incomplete — seed missing products silently
      const fbIds = snap.docs.map(d => d.data().id);
      const missing = DEFAULT_PRODUCTS.filter(p => !fbIds.includes(p.id));
      missing.forEach(p => db.collection("products").add(p).catch(() => {}));
      // Keep using defaults while Firebase seeds
...
function renderProducts(filter="all") {
  ...
  grid.innerHTML = list.map((p,i) => {
    ...
    return `<div class="pcard" style="animation:cardin 0.4s ease ${i*0.04}s both">
      <div class="pimg">
        ...
        <button class="wish-btn ${iw?"on":""}" data-wish="${p.id}">
  ...
  // Event delegation — single handler, always works
  grid.onclick = e => {
    const cart  = e.target.closest("[data-addcart]");
    const wish  = e.target.closest("[data-wish]");
    const modal = e.target.closest("[data-modal]");
    if (cart)  addToCart(Number(cart.dataset.addcart));
    if (wish)  toggleWish(Number(wish.dataset.wish), wish);
    if (modal) openModal(Number(modal.dataset.modal));
  };
}
...
function openModal(id) {
  ...
  document.getElementById("modal-body").innerHTML = `
    <div class="modal-grid">
      ...
      <div>
        ...
        <div class="mbtns">
          <button class="btn-primary" id="m-add"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
          <button class="btn-glass"   id="m-buy"><i class="fa fa-bolt"></i> Buy Now</button>
  ...
  document.getElementById("qminus").onclick = () => { const i=document.getElementById("modal-qty"); if(i) i.value=Math.max(1,parseInt(i.value)-1); };
  document.getElementById("qplus").onclick  = () => { const i=document.getElementById("modal-qty"); if(i) i.value=parseInt(i.value)+1; };
  document.getElementById("m-add").onclick  = () => { addToCart(id,qty()); closeModal(); };
  document.getElementById("m-buy").onclick  = () => { addToCart(id,qty()); closeModal(); setTimeout(openCheckout,300); };
  document.getElementById("m-wish").onclick = function() {
    toggleWish(id,null);
...
function openCheckout() {
  ...
  document.getElementById("co-total-amt").textContent = Rs(total);
  closeCart();
...
function placeOrder(e) {
  ...
  if (!name||!phone||!address||!city) { toast("Please fill all required fields!","fa-exclamation-circle","#ef4444"); return; }
  ...
  db.collection("orders").add({
    ...
    items, total, payment:pay, status:"pending",
  ...
  document.getElementById("checkout-body").innerHTML=`
    <div class="order-success">
      ...
      <p style="font-size:12px;color:var(--muted);margin-bottom:20px">Delivery to <strong>${city}</strong>: 1–3 business days</p>
...
function initSearch() {
  ...
  input.addEventListener("input",()=>{
    ...
    drop.innerHTML=!m.length
      ...
      :m.map(p=>`<div class="sdr" data-sid="${p.id}">
...
function initTheme(){
  ...
  btn?.addEventListener("click",()=>{
    ...
    toast(next==="light"?"Light mode ☀️":"Dark mode 🌙","fa-adjust");
  });
}
...
function updateWABtn(){
  ...
  const tip=btn.querySelector(".wa-tip");
  if(cart.length){
    ...
    if(tip) tip.textContent="Order via WhatsApp!";
  } else {
    btn.href="https://wa.me/9779763332837";
    if(tip) tip.textContent="Chat with us!";
  }
}
...
function bindEvents(){
  ...
  document.querySelectorAll('input[name="pay"]').forEach(r=>r.addEventListener("change",()=>toggleEsewa(r.value)));
  // Login
...
document.head.insertAdjacentHTML("beforeend",
  "<style>@keyframes cardin{from{opacity:0;transform:scale(0.95)}to{opacity:1;transform:scale(1)}}</style>");
