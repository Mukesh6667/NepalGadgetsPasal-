...
const PRODUCTS = [
  { id:1,  name:"iPhone 15 Pro",         brand:"Apple",    cat:"smartphones",  price:189900, old:219900, disc:14, rating:4.9, rev:892,  icon:"fa-mobile-alt",     img:"https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=400&h=400&fit=crop&auto=format", desc:"Titanium design, A17 Pro chip, 48MP camera, up to 29hr video playback. Available in Natural, Black, White and Blue Titanium.", specs:[["Display","6.1\" Super Retina XDR"],["Chip","A17 Pro Bionic"],["Camera","48MP + 12MP + 12MP"],["Battery","Up to 23 hr"],["Storage","128GB / 256GB / 512GB"],["OS","iOS 17"]] },
  { id:2,  name:"Samsung Galaxy S24",    brand:"Samsung",  cat:"smartphones",  price:109900, old:129900, disc:15, rating:4.7, rev:643,  icon:"fa-mobile-alt",     img:"https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?w=400&h=400&fit=crop&auto=format", desc:"Galaxy AI features, 50MP camera with 30x Space Zoom, Snapdragon 8 Gen 3. The smartest Galaxy ever.", specs:[["Display","6.2\" Dynamic AMOLED 2X"],["Chip","Snapdragon 8 Gen 3"],["Camera","50MP + 10MP + 12MP"],["Battery","4000 mAh"],["Storage","128GB / 256GB"],["OS","Android 14"]] },
  { id:3,  name:"MacBook Air M3",        brand:"Apple",    cat:"laptops",      price:169900, old:189900, disc:11, rating:4.9, rev:412,  icon:"fa-laptop",         img:"https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400&h=400&fit=crop&auto=format", desc:"11.5mm thin, 1.24kg, M3 chip, up to 18 hours battery. The world's best consumer laptop.", specs:[["Chip","Apple M3"],["Display","13.6\" Liquid Retina"],["RAM","8GB / 16GB / 24GB"],["Storage","256GB – 2TB SSD"],["Battery","Up to 18 hr"],["Weight","1.24 kg"]] },
  { id:4,  name:"Dell XPS 15",           brand:"Dell",     cat:"laptops",      price:229900, old:259900, disc:12, rating:4.6, rev:287,  icon:"fa-laptop",         img:"https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=400&h=400&fit=crop&auto=format", desc:"15.6\" OLED display, Intel Core i7, NVIDIA RTX 4060. The ultimate Windows laptop for creators.", specs:[["Processor","Intel Core i7-13700H"],["Display","15.6\" OLED 3.5K"],["RAM","16GB DDR5"],["Storage","512GB NVMe SSD"],["GPU","NVIDIA RTX 4060"],["Battery","86Whr"]] },
  { id:5,  name:"Sony WH-1000XM5",       brand:"Sony",     cat:"earbuds",      price:44900,  old:54900,  disc:18, rating:4.8, rev:1204, icon:"fa-headphones-alt", img:"https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=400&h=400&fit=crop&auto=format", desc:"Industry-leading noise cancellation, 30hr battery, V1 chip for crystal clear calls. Headphones perfected.", specs:[["Driver","30mm Dome"],["ANC","Industry Best"],["Battery","30 hr ANC on"],["Charging","USB-C Quick Charge"],["Bluetooth","5.2"],["Weight","250g"]] },
  { id:6,  name:"Apple Watch Series 9",  brand:"Apple",    cat:"smartwatches", price:59900,  old:69900,  disc:14, rating:4.8, rev:723,  icon:"fa-clock",          img:"https://images.unsplash.com/photo-1579586337278-3befd40fd17a?w=400&h=400&fit=crop&auto=format", desc:"S9 chip, brighter always-on display, double tap gesture, ECG and blood oxygen sensors.", specs:[["Chip","Apple S9 SiP"],["Display","Always-On LTPO OLED"],["Battery","Up to 18 hr"],["Water","50m"],["Health","ECG, Blood O2"],["Bluetooth","5.3"]] },
  { id:7,  name:"JBL Charge 5",          brand:"JBL",      cat:"speakers",     price:19900,  old:24900,  disc:20, rating:4.7, rev:956,  icon:"fa-volume-up",      img:"https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=400&h=400&fit=crop&auto=format", desc:"40W Pro Sound, 20hr playtime, IP67 waterproof, built-in powerbank. Sound anywhere, anytime.", specs:[["Output","40W"],["Battery","20 hr"],["Waterproof","IP67"],["Bluetooth","5.1"],["PartyBoost","Yes"],["Weight","960g"]] },
  { id:8,  name:"Logitech G502 X",       brand:"Logitech", cat:"gaming",       price:12900,  old:15900,  disc:19, rating:4.6, rev:574,  icon:"fa-gamepad",        img:"https://images.unsplash.com/photo-1527814050087-3793815479db?w=400&h=400&fit=crop&auto=format", desc:"LIGHTFORCE hybrid switches, HERO 25K sensor, 13 programmable buttons. Engineered for champions.", specs:[["Sensor","HERO 25K"],["DPI","100-25,600"],["Switches","LIGHTFORCE"],["Buttons","13 Prog."],["Weight","89g"],["Interface","USB"]] },
  { id:9,  name:"OnePlus 12",            brand:"OnePlus",  cat:"smartphones",  price:89900,  old:99900,  disc:10, rating:4.6, rev:398,  icon:"fa-mobile-alt",     img:"https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=400&h=400&fit=crop&auto=format", desc:"Snapdragon 8 Gen 3, Hasselblad cameras, 100W SUPERVOOC, 5400mAh battery. Never compromise on performance.", specs:[["Display","6.82\" AMOLED"],["Chip","Snapdragon 8 Gen 3"],["Camera","50MP Hasselblad"],["Battery","5400mAh / 100W"],["Storage","256 / 512GB"],["OS","OxygenOS 14"]] },
  { id:10, name:"GoPro Hero 12",         brand:"GoPro",    cat:"cameras",      price:54900,  old:64900,  disc:15, rating:4.7, rev:329,  icon:"fa-camera",         img:"https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=400&h=400&fit=crop&auto=format", desc:"5.3K60 video, 27MP photos, HyperSmooth 6.0, waterproof to 10m. Capture every adventure.", specs:[["Video","5.3K60 / 4K120"],["Photo","27MP"],["Stabilization","HyperSmooth 6.0"],["Waterproof","10m"],["Battery","1720mAh"],["Weight","154g"]] },
  { id:11, name:"Samsung Galaxy Watch 6",brand:"Samsung",  cat:"smartwatches", price:39900,  old:49900,  disc:20, rating:4.5, rev:412,  icon:"fa-clock",          img:"https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400&h=400&fit=crop&auto=format", desc:"Advanced sleep analysis, BIA body composition, sapphire crystal glass, 40hr battery life.", specs:[["Display","1.3\" Super AMOLED"],["Processor","Exynos W930"],["Battery","40 hr"],["Water","5ATM + IP68"],["Health","BIA, ECG, SpO2"],["OS","Wear OS 4"]] },
  { id:12, name:"JBL Tune Buds",         brand:"JBL",      cat:"earbuds",      price:8900,   old:11900,  disc:25, rating:4.4, rev:863,  icon:"fa-headphones-alt", img:"https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=400&h=400&fit=crop&auto=format", desc:"48hr total battery, Active Noise Cancelling, 4 mics, JBL Pure Bass Sound at an incredible price.", specs:[["Battery (Bud)","10hr ANC"],["Battery (Total)","48hr"],["ANC","Yes"],["Driver","10mm"],["Bluetooth","5.3"],["Water","IPX4"]] }
];
